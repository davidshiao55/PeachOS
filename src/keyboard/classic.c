...
// Mapping from scan code(index of array) to ascii keypressed
...
struct keyboard classic_keboard = {
    .name = "classic",
...
int classic_keyboard_init()
{
    // Write 0xAE to 0x64 port to enable first PS/2 port
